...
const Register = () => {
  ...
  const handleRegister = (event) => {
    ...
    dispatch(register(username, password, email, firstName, lastName, emailUpdates))
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                helperText={registerClicked && error && error.first_name ? error.first_name : ''}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                helperText={registerClicked && error && error.last_name ? error.last_name : ''}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                helperText={registerClicked && error && error.username ? error.username : ''}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                helperText={registerClicked && error && error.email ? error.email : ''}
              />
            </Grid>
            <Grid item xs={12}>
              <PasswordInput
                ...
                helperText={registerClicked && error && error.password ? error.password : ''}
              />
            </Grid>
            <Grid item xs={12}>
              <FormControlLabel
